        ...
        <SectionLayout id={"about-us"} className={"lg:gap-8 md:flex-col lg:flex-row"}>
            <div className={"lg:w-1/2"}>
                ...
                <div className={"text-left flex flex-col justify-start"}>
                    <p className={"text-2xl text-secondary-950 pb-4 leading-relaxed"}>Somos una empresa joven con <span
                        className={"font-bold"}>amplia experiencia</span> en el rubro de almacenamiento, transporte,
                        logística, reparación.</p>
                    <p className={"text-2xl text-secondary-950 pb-4 leading-relaxed"}>Contamos con <span
                        className={"font-bold"}>atención personalizada</span> para
                        todos nuestros clientes.</p>
                    <p className={"text-2xl text-secondary-950 pb-4 leading-relaxed"}>Nuestro mayor capital es la <span
                        className={"font-bold"}>calidad humana</span> de todos nuestros trabajadores.</p>
                    <p className={"text-2xl text-secondary-950 pb-4 leading-relaxed"}>Tenemos atención rápida y
                        directa <span
            ...
            <div className="grid grid-cols-2 gap-2 lg:gap-4 lg:w-1/2 h-[450px] md:h-[600px] rounded-2xl overflow-clip">
                <div className="grid grid-rows-2 gap-2 lg:gap-4 object-cover">
                    <img src={imgService7} alt="Imagen 1" className="w-full h-full object-cover bg-primary-200"/>
                    <img src={imgService12} alt="Imagen 2" className="w-full h-full object-cover bg-primary-600"/>
                </div>
                <div className={"bg-secondary-300"}>
                    <img src={imgService17} alt="Imagen 3" className="w-full h-full object-cover bg-primary-200"/>
                </div>
            </div>
        </SectionLayout>
    );
