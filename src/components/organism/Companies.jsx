...
function Companies() {
    const brands = [
        ...
        {id: 4, name: "Mediterranean shipping company", img: mediterraneanLogo, customClass: "h-full"},
    ...
    return (
        <SectionLayout id={"companies"} className={"bg-primary-600 gap-8 md:flex-col lg:flex-row"}>
            ...
            <div className={"grid grid-cols-2 gap-4 lg:grid-cols-5 w-full"}>
                {brands.map(brand => {
                    return (
                        <div key={brand.id} className={"w-full h-[75px] flex justify-center items-center object-fill"}>
                            <img
